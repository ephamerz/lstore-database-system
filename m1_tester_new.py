...
for key in records:
    ...
    for j, column in enumerate(record.columns):
        if column != records[key][j]:
            ...
            error = True
    if error:
        print('version -1 update error on', records[key], 'and', updated_columns, ':', record.columns, ', correct:', records[key])
    else:
        pass
    ...
    for j, column in enumerate(record.columns):
        if column != records[key][j]:
            error = True
    if error:
        print('version -2 update error on', records[key], 'and', updated_columns, ':', record.columns, ', correct:', records[key])
    else:
        pass
        #print('update on', original, 'and', updated_columns, ':', record)
    ...
    for j, column in enumerate(record.columns):
        if column != updated_records[key][j]:
            error = True
    if error:
        print('version 0 update error on', records[key], 'and', updated_columns, ':', record.columns, ', correct:', updated_records[key])
