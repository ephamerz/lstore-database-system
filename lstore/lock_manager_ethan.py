...
class LockManager:
    ...
    def acquire(self, transaction_id, table_name, rid, lock_type):
        ...
        with self.lock:
            ...
            # for if the transcation requesting the lock already has a lock on the record
        ...
        with self.lock:
            ...
            for key in keys_to_clean:
                ...
                if not entry["holders"]:
                    ...
                    # if the remaining holders exist, the lock has to be shared??
                    entry["lock_type"] = SHARED